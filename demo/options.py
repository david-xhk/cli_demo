    ...
    def register(self, option, desc="", **kwargs):
        ...
        Note:
            ...
            * If `option` is an input function key:
              ...
              * Any response to that input function which does not fall within its designated options will be forwarded to the :attr:`~demo.options.Option.callback` via the :meth:`~demo.options.Option.call` method of the :class:`~demo.options.Option` instance for further processing.
